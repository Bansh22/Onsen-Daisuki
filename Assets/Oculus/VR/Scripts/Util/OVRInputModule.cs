...
namespace UnityEngine.EventSystems
{
    ...
    public class OVRInputModule : PointerInputModule
    {
        ...
        virtual protected MouseState GetGazePointerData()
        {
            ...
            L_Cursor.SetCursorRay(LeftrayTransform);
            ...
            if (ovrRaycaster)
            {
                ...
                if (graphicRect != null)
                {
                    ...
                    L_Cursor.SetCursorStartDest(LeftrayTransform.position, worldPos, normal);
                }
            }
            ...
            if (physicsRaycaster)
            {
                ...
                L_Cursor.SetCursorStartDest(LeftrayTransform.position, position, raycast.worldNormal);
            }
